...
If we would like to provide column name, or a function name, as a character variables,
we can use `env` argument in `data.table` query:

```{r dtenv}
col = "Weight"
fun = "mean"
out_col = paste(fun, col, sep="_")
cw[, .(out_col = fun(col)), env = list(col=col, fun=fun, out_col=out_col)]
```
