...
have different categories (see the `<fct>` variables below). Currently R sees them as 
continuous variables. It will simplify our coding. The next section will explain the 
`mutate()` function.
```{r makeFactor}
...
In this section we will learning how to wrangle (manipulate) datasets using the `tidyverse`
