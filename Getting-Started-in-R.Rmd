...
brings with both its history of development, and development model.  By adding another package, we open
a door to interface changes we no longer control.  It is clearly valuable at times, yet one has to remain
aware of the costs that may accrue as a consequence.
...
In reality you will end up doing multiple data wrangling steps that you want to save.
Neither are optimal as they have their own issues. This is where the 'chaining' 
of `data.table` operations comes to the rescule
`%>%` comes to the rescue:
