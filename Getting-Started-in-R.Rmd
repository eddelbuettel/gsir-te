...
>>>>>>> parent of e1ce6a7... Removed the "j to summarise" for three reasons. 1) Summarising by Die…t given the data does not make sense (we could change it to `.(Diet, Time)` but 2) we cover summaries in Section 14, 3) It is consistent with GSiR tidyverse edition. I am working on another edition want them all to be consistent.
