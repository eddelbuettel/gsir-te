...
and expecting instructions to do something.
...
\texttt{\textless{}fct\textgreater{}} variables below). Currently R sees
them as continuous variables. It will simplify our coding. The next
section will explain the \texttt{mutate()} function.
...
In this section we will learning how to wrangle (manipulate) datasets
using the \texttt{tidyverse} package. Let's start with the
